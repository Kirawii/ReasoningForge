...
## AutoDL / local 2-GPU deployment adaptation

For a single AutoDL host with 2 x RTX 5090 (policy on GPU 0, vLLM on GPU 1),
use the deployment-only instructions in [AUTODL_LOCAL.md](./AUTODL_LOCAL.md).
This path preserves the official Modal setup and does not implement assignment
algorithms or change the tests.
